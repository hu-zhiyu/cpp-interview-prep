...
* 实习介绍
* 编程：删除有序链表中的重复节点
* 在浏览器中输入 www.baidu.com 依次会经历哪些层，具体过程是怎么样的
* DNS 使用的是 UDP 协议还是 TCP 协议
* 迭代查询和递归查询
* 熟悉哪些常用的 Linux 命令
...
* 线程进程区别，各自适用于什么场景
* 线程同步和线程异步的区别
* ArrayList和HashMap底层实现
* 常见性能优化的方法
* 常见的大数据处理算法(SVM, KMeans), 偏导
* 将一个大对象存入内存会有什么问题

### tplink
* 使用 vector 和数组相比有什么好处
* ping 的原理
* Fibonacci 有什么用
* 翻转字符串
* 内联函数相对于宏有什么优势
